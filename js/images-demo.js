...
var load_data_batch = function(batch_num) {
  ...
  data_img_elt.src = dataset_name + "/" + dataset_name + "_batch_" + batch_num + ".png?random=" + Math.random();
}
...
var testImage_NoVis = function(img) {
    ...
    //var probsdiv = document.createElement('div');
    var probsdiv = document.getElementById('test_result');
...
var load_pretrained = function() {
  $.getJSON(dataset_name + "/" + network_name + "_snapshot.json", function(json){
    net = new convnetjs.Net();
    net.fromJSON(json);
